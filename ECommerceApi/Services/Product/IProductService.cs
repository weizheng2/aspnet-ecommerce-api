...
namespace ECommerceApi.Services
{
    ...
    {
        Task<Result<PagedResult<GetProductDto>>> GetAllProductsAsync(PaginationDto paginationDto);
        Task<Result<PagedResult<GetProductDto>>> GetProductsFilterAsync(FilterProductDto filterProductDto);
